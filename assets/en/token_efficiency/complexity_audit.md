...
description: >
  Whole-repo audit for over-engineering. Like simplification-review, but scans the
  entire codebase instead of a diff: a ranked list of what to delete, simplify,
  or replace with stdlib/native equivalents. Trigger with "audit this codebase",
  "audit for over-engineering", or the command /complexity-audit.
license: MIT
---

# Complexity and Over-Engineering Audit
